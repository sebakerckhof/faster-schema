...
This package is mainly meant as a limited, but faster alternative to [FasterSchema](https://github.com/aldeed/simple-schema-js/), with a very similar API. Here's a complete comparison: .
In short: the main difference is that this package doesn't support validating against mongoDB modifiers. But in our tests on an advanced schema with a large object, it is about 10x faster for validation and 20x faster for cleaning of data.
...
- [The History of FasterSchema](#the-history-of-simpleschema)
...
- [Other FasterSchema Methods](#other-simpleschema-methods)
